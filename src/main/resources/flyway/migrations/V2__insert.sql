...
VALUES (1, 'K29.3', 'хронический поверхностный гастрит'),
       ...
       (4, 'K21', 'гастроэзофагеальный рефлюкс'),
       (5, 'K30', 'функциональная диспепсия'),
       (6, 'K25.1', 'язва желудка остарая с прободением'),
       (7, 'K25.7', 'Хроническая язва желудка без кровотечения или прободения');
